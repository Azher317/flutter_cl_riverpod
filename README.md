# Riverpod structure
A flutter project built on Clean Architecture, structured with riverpod, shared preferences, retrofit, goRouter.
...
and same for ios from ..ios/Runner/info.plist, and search for example.com, then change the name to your host name.
