...
## Corpus Check
- 226 files · ~71,862 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2250 nodes · 2750 edges · 164 communities (115 shown, 49 thin omitted)
...
9. `Managing Dart Dependencies` - 8 edges
10. `2. Syntax Reference` - 8 edges
...
Cohesion: 0.05
Nodes (45): authRemoteDataSourceProvider, class AuthRemoteDataSourceProvider, SafeRepositoryCall, call, NoParamsUseCase, UseCase, _api, AuthRemoteDataSource (+37 more)

### Community 6 - "Kurdish Cupertino Localizations"
Cohesion: 0.10
Nodes (21): build, CachedImage, _CachedImageState, cacheKey, createState, devicePixelRatioCap, _errorBox, fit (+13 more)

### Community 7 - "API Headers"
Cohesion: 0.22
Nodes (8): IconData, action, build, EmptyState, icon, message, title, package:app/core/widgets/state_ui/state_message.dart
...
Cohesion: 0.25
Nodes (7): ChangeNotifier, dispose, RouterRefreshNotifier, _sub, package:flutter/foundation.dart, package:flutter_riverpod/flutter_riverpod.dart, ProviderSubscription
...
Cohesion: 0.06
Nodes (32): AutovalidateMode?, CrossAxisAlignment, GlobalKey, FormStateX, build, children, ColumnPadded, crossAxisAlignment (+24 more)
...
Cohesion: 0.12
Nodes (15): customAppBar, isElevated, LeadingButton, _onBack, build, DefaultErrorWidget, error, onRetry (+7 more)

### Community 24 - "Login Request Model"
Cohesion: 0.11
Nodes (17): isSignedIn, logout, SessionController, user, build, isSignedIn, logout, setSession (+9 more)
...
Cohesion: 0.12
Nodes (18): _, @riverpod, authRepositoryProvider, dioProvider, flutterSecureStorageProvider, dio, sessionProvider, Session (+10 more)
...
Cohesion: 0.11
Nodes (20): FormBody, CustomTextFormField, CustomText, build, child, _ComponentGallery, _DetailPreview, _OverlayGallery (+12 more)

### Community 32 - "Asset Generation Script"
Cohesion: 0.15
Nodes (15): AppLocalizations get, BuildContext, double get, AppLocalizationsExtension, DeviceHeight, DeviceWidth, height, iraqiPhoneNumber (+7 more)
...
Cohesion: 0.08
Nodes (29): DateTime? firstDate,, HookConsumerWidget, ValueNotifierUpdated, build, CustomDatePickerFormField, labelText, lastDate, selectedDateNotifier (+21 more)

### Community 35 - "Default Error Widget"
Cohesion: 0.06
Nodes (41): apiConsumerProvider, dart:io, Dio, Exception, BadRequestException, CacheException, ConflictException, ForbiddenException (+33 more)
...
Cohesion: 0.13
Nodes (14): AsyncValue, build, children, isLoading, onAdd, titleText, createState, package:app/core/messaging/failure_messenger.dart (+6 more)
...
Cohesion: 0.10
Nodes (19): CroppedFile?, cropImage, getOppositeThemeMode, ThemeX, build, height, hintText, icon (+11 more)
...
Cohesion: 0.25
Nodes (7): AppMessenger, key, MessageType, show, ScaffoldMessengerState, static final, _
...
Cohesion: 0.12
Nodes (14): @JsonEnum, dart:async, copyWith, data, fromJson, message, RoleDto, statusCode (+6 more)

### Community 48 - "Dio Module & Logout"
Cohesion: 0.33
Nodes (5): Adding a feature, Catalogue, Conventions, Files — one per layer, mirroring `lib/features/<feature>/`, Snippets (VS Code)
...
Cohesion: 0.08
Nodes (24): FocusNode?, controller, debounced, DebouncedSearch, useDebouncedSearch, value, build, controller (+16 more)
...
Cohesion: 0.33
Nodes (6): ConsumerState, build, LoginScreen, _LoginScreenState, StatefulHookConsumerWidget, loginProvider
...
Cohesion: 0.17
Nodes (11): int?, Paginated, count, fromJson, pageNumber, pageSize, PaginatedResponse, result (+3 more)

### Community 64 - "Web Manifest"
Cohesion: 0.50
Nodes (3): How to audit, How to report, Project conventions to enforce
...
Cohesion: 0.29
Nodes (6): File, FileJsonConvertor, fromJson, toJson, MultipartFile, package:app/core/network/clients_lib.dart
...
Cohesion: 0.11
Nodes (17): ItemType, addItems, defaultLimitSize, firstPage, result, total, defaultListDelegate, _pageLoader (+9 more)
...
Cohesion: 0.22
Nodes (8): appName, main, runZonedGuarded, package:app/app.dart, package:app/core/observability/app_logger.dart, package:app/core/storage/shared_preferences_provider.dart, package:flutter_driver/driver_extension.dart, package:talker_riverpod_logger/talker_riverpod_logger.dart
...
Cohesion: 0.29
Nodes (6): ARB entry shape, Consume in a widget, Ground truth (verify before editing), Hard rule (CLAUDE.md rule 11), Localization (this project), Workflow: add or edit a string
...
Cohesion: 0.29
Nodes (6): Deep linking, Ground truth (verify before editing), Hard rule (CLAUDE.md rule 15), Nested navigation (shells), Routing (this project), Workflow: add a route
...
Cohesion: 0.67
Nodes (3): LocaleDirectionX, OppesitLocaleDirectionX, WidgetRef
...
Cohesion: 0.32
Nodes (8): @freezed, AppSettings, SessionCacheModel, AppSettings, _AppSettings, jsonSerializable, UserModel, AppSettingsPatterns
...
Cohesion: 0.26
Nodes (11): bool get, L, Either, hashCode, isLeft, isRight, Left, operator (+3 more)

### Community 159 - "session_provider.dart"
Cohesion: 0.18
Nodes (10): class SessionControllerProvider, sessionControllerProvider, sessionController, package:app/core/session/session_controller.dart, _, create, debugGetCreateSourceHash, extends (+2 more)
...
## Knowledge Gaps
- **1421 isolated node(s):** `deep_link.sh script`, `pngDir`, `svgDir`, `outputPath`, `pngs` (+1416 more)
...
- **Why does `sharedPreferences` connect `Pagination Controller Hook` to `Dio Authenticator Interceptor`?**
